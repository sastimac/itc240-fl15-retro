...
$body ="this is a message from the iig website!:\n";
...
$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: collectingroots@msn.com' . "\r\n";
// sends bcc to alternate address 

//Creates intelligible subject line that shows where it came from
$subject = 'Email from the IIG website'; // if your client has more than one web site, you can put the site name here.
...
mail ('sastimac@comcast.net', $subject, $body, $from);

header('Location: thx-webmaster.html'); // replace "thx.html" with the name and path to your actual thank you page