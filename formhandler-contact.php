...
mail ('collectingroots@msn.com', $subject, $body, $from);

header('Location: thx-contacts.html'); // replace "thx.html" with the name and path to your actual thank you page